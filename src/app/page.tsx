          ...
          >
            <div className="space-y-6 lg:max-w-xl">
              ...
              <div className="flex flex-wrap gap-6 text-sm text-slate-400">
                <a
                  href="https://drive.google.com/file/d/14hTeJOqg3oShfl2DwJb40b_JfuaXzK2W/view?usp=drivesdk"
                  target="_blank"
              ...
              <div className="space-y-6">
                ...
                <div className="relative flex gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    {/* <p className="text-sm text-slate-400">
                      Focused on MERN stack, real-world projects, and
                      problem-solving.
                    </p> */}
                  </div>
                </div>
            ...
            <div className="max-w-xl mx-auto space-y-8">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex items-center gap-4">
                  ...
                  {/* Instagram */}
                  <a
                    href="https://www.instagram.com/i.m.payalkarn__?igsh=MTAybjMzbGEwMmh1bA=="
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-900/80 border-2 border-slate-700 text-pink-400 hover:bg-pink-500/10 hover:border-pink-400 hover:text-pink-300 hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300 backdrop-blur-sm"
              ...
              {/* Form exactly in center */}
              <form className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 md:p-7">
                ...
                />
                <button className="w-full rounded-xl bg-sky-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-sky-500/30 hover:bg-sky-400 hover:shadow-sky-500/50 transition">
                  Send Message
                </button>
              </form>
            </div>
